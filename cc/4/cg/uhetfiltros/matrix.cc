...
void Vector::matrix2vector(int i, int j, int n, Matrix* m){
...
int Vector::get_pos_menor(int ini){
...
void Matrix::set(int i, int j, int cor){
...
int Matrix::toCinza(int red, int green, int blue){
...
void Matrix::set(int i, int j, int red, int green, int blue){
...
int fMatrix::getLinhas(){
	
	return this->linhas;
}

int fMatrix::getColunas(){
	
	return this->colunas;
}


void fMatrix::set(int i, int j, float cor){
...
float fMatrix::toCinza(float red, float green, float blue){

	return 0.299*red + 0.587*green + 0.114*blue ;

}

void fMatrix::set(int i, int j, float red, float green, float blue){
