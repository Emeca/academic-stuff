...
Bmp::Bmp(int largura, int altura, int resolucao, int r, int g, int b, string arquivo){
...
Bmp::Bmp(string arquivo){

	this->ReadFromFile(arquivo.c_str());
}

void Bmp::teste(int r, int g, int b){
...
void Bmp::pintarPixel(int i, int j, int r, int g, int b){
...
void Bmp::pintarPixel(int i, int j, float* fbmp){
