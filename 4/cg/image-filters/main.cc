...
main(int argc, char *argv[])
{
	...
	if (argc == 1) {
		...
		Bmp *bmp_mcinza = matrix2bmp(mcinza);
		bmp_mcinza->WriteToFile("gnu_cinza.bmp");
		Bmp *bmp_mtshould = matrix2bmp(mtshould);
		bmp_mtshould->WriteToFile("gnu_tshould.bmp");
		Bmp *bmp_mborda = matrix2bmp(mborda);
		bmp_mborda->WriteToFile("gnu_borda.bmp");
		Bmp *bmp_mecor = matrix2bmp(mecor);
		bmp_mecor->WriteToFile("gnu_ecor.bmp");
		Bmp *bmp_mmediana = matrix2bmp(mmediana);
		bmp_mmediana->WriteToFile("gnu_mediana.bmp");
		Bmp *bmp_mpalta = matrix2bmp(mpalta);
		bmp_mpalta->WriteToFile("gnu_palta.bmp");
		Bmp *bmp_mpbaixa = matrix2bmp(mpbaixa);
		bmp_mpbaixa->WriteToFile("gnu_pbaixa.bmp");
		Bmp *bmp_mroberts = matrix2bmp(mroberts);
		bmp_mroberts->WriteToFile("gnu_roberts.bmp");
		Bmp *bmp_msobel = matrix2bmp(msobel);
		bmp_msobel->WriteToFile("gnu_sobel.bmp");
		Bmp *bmp_mhb = matrix2bmp(mhb);
		bmp_mhb->WriteToFile("gnu_hb.bmp");
		...
		cout << "sintaxe: " << argv[0] << " <opcao> <arquivo_de_entrada>" <<
			endl;
	}
